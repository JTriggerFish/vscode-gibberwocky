...
export function activate(context: vscode.ExtensionContext) {
    ...
    let delayedExecDisposable = vscode.commands.registerCommand('gibberwocky.delayedExecute',
        ...
        try{
            Gibber.Scheduler.functionsToExecute.push(
                new loophole.Function(textF).bind(Gibber.currentTrack));
    ...
    let execDisposable = vscode.commands.registerCommand('gibberwocky.execute', 
        function () {
    ...
    let clearDisposable = vscode.commands.registerCommand('gibberwocky.clear',
        function () {
