...
let momView = {
  ...
  onLeafClick( leaf, evt ) {
    console.log('OnLeaf click ' + leaf + ' momtree TODO ')
    ...
    // const cursorPos = Gibber.Codemirror.getCursor()
    ...
    //     Gibber.Codemirror.replaceRange( txt, cursorPos, end )
    //     Gibber.Codemirror.focus()
    //   }
    // }
  ...
  processDevice( device, id ) {
    console.log('Process device' + device + ' momtree TODO ')
  ...
  create() { 
    console.log('Create : momtree TODO ')
